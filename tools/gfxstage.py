...
def encode(input_base: str, output_file: str):
    ...
    def encode_clut(dst: bytearray, file_name: str):
        ...
        row_list = unroll_rows(rows)
        for i in range(0, 16):
            encode_pal(dst, clut_indices[0x0] +
                       0x40 * i, row_list[i * 16 + 0x0])
            encode_pal(dst, clut_indices[0x1] +
                       0x40 * i, row_list[i * 16 + 0x1])
            encode_pal(dst, clut_indices[0x2] +
                       0x40 * i, row_list[i * 16 + 0x2])
            encode_pal(dst, clut_indices[0x3] +
                       0x40 * i, row_list[i * 16 + 0x3])
            encode_pal(dst, clut_indices[0x4] +
                       0x40 * i, row_list[i * 16 + 0x4])
            encode_pal(dst, clut_indices[0x5] +
                       0x40 * i, row_list[i * 16 + 0x5])
            encode_pal(dst, clut_indices[0x6] +
                       0x40 * i, row_list[i * 16 + 0x6])
            encode_pal(dst, clut_indices[0x7] +
                       0x40 * i, row_list[i * 16 + 0x7])
            encode_pal(dst, clut_indices[0x8] +
                       0x40 * i, row_list[i * 16 + 0x8])
            encode_pal(dst, clut_indices[0x9] +
                       0x40 * i, row_list[i * 16 + 0x9])
            encode_pal(dst, clut_indices[0xA] +
                       0x40 * i, row_list[i * 16 + 0xA])
            encode_pal(dst, clut_indices[0xB] +
                       0x40 * i, row_list[i * 16 + 0xB])
            encode_pal(dst, clut_indices[0xC] +
                       0x40 * i, row_list[i * 16 + 0xC])
            encode_pal(dst, clut_indices[0xD] +
                       0x40 * i, row_list[i * 16 + 0xD])
            encode_pal(dst, clut_indices[0xE] +
                       0x40 * i, row_list[i * 16 + 0xE])
            encode_pal(dst, clut_indices[0xF] +
                       0x40 * i, row_list[i * 16 + 0xF])
...
def decode(input_file: str, output_base: str, pal_idx: int):
    ...
    def generate_clut(output_file: str, src: bytes):
        ...
        img.data = bytearray(img.size())
        for i in range(0, 16):
            copy_pal(img.data, i * 0x10 + 0x0,
                     src[clut_indices[0x0] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0x1,
                     src[clut_indices[0x1] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0x2,
                     src[clut_indices[0x2] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0x3,
                     src[clut_indices[0x3] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0x4,
                     src[clut_indices[0x4] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0x5,
                     src[clut_indices[0x5] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0x6,
                     src[clut_indices[0x6] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0x7,
                     src[clut_indices[0x7] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0x8,
                     src[clut_indices[0x8] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0x9,
                     src[clut_indices[0x9] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0xA,
                     src[clut_indices[0xA] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0xB,
                     src[clut_indices[0xB] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0xC,
                     src[clut_indices[0xC] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0xD,
                     src[clut_indices[0xD] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0xE,
                     src[clut_indices[0xE] + 0x40 * i:])
            copy_pal(img.data, i * 0x10 + 0xF,
                     src[clut_indices[0xF] + 0x40 * i:])
        img.write(output_file)
